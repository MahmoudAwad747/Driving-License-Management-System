...
namespace DVLD.Licenses.Controls
{
    public partial class ctrlDriverLicenses : UserControl
    {
        ...
        private void _LoadLocalLicenseInfo()
        {
            ...
            //_dtDriverLocalLicensesHistory.DefaultView.Sort = "LicenseID ASC";
        ...
        private void _LoadInternationalLicenseInfo()
        {
            ...
            //_dtDriverInternationalLicensesHistory.DefaultView.Sort = "InternationalLicenseID ASC";

            lblRecordsCountInternational.Text = dgvInternationalLicensesHistory.Rows.Count.ToString();
        ...
        public void LoadInfo(int DriverID)
        {
            ...
            if(_Driver == null)
            {
                MessageBox.Show("There is no driver with id = " + _DriverID, "Error", MessageBoxButtons.OKCancel, MessageBoxIcon.Exclamation);
                return;
            }
        ...
        public void LoadInfoByPersonID(int PersonID)
        {
            ...
            if (_Driver == null)
            {
                MessageBox.Show("There is no driver linked with person with id = " + PersonID, "Error", MessageBoxButtons.OKCancel, MessageBoxIcon.Exclamation);
                return;
            }
